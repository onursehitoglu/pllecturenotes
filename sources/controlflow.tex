...
\item Multiple uses: \structure{callbacks}, \structure{generators} (iterators), \structure{threads}, \structure{fibers}, \structure{asynchronous} or \structure{concurrent} programming
\end{itemize}
\end{frame}
\end{document}
